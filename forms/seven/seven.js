...
// Code
/*
let carPayment = Number(prompt("What is the monthly amount of your car payment in dollars?"))
let rentPayment = Number(prompt("What is the monthly amount of your rent payment in dollars?"))
let creditCardPayment = Number(prompt("What is the monthly amount of your credit card payment in dollars?"))
let grossIncome = Number(prompt("What is the amount of your monthly gross income in dollars?"))

let totalDebt = carPayment + rentPayment + creditCardPayment
let totalIncome = grossIncome
let debtToIncome = (totalDebt / totalIncome) * 100

console.log(`Your debt-to-income ratio is ${debtToIncome}%`)
*/